...
def plotTogether(ax, axa, dataB, dataG, dataF, sec):
    '''
    ...
    ax.set_title(sec, fontweight = 'bold')
...
df1 = pd.DataFrame(
    ...
    # set 'sector' and 'country' as index
...
with PdfPages('DataVisualization2.0.pdf') as pdf:
    pdf.savefig(fig3)
    pdf.savefig(fig4)
    pdf.savefig(fig1)
    pdf.savefig(fig2)
