...
def transformation_tab(company_data, founder_data, gis_data, industry_data,
    ...
    def make_par_chart(src):
        p = figure(plot_width = 550, plot_height = 550,
            ...
            tools = 'hover',
            tooltips = '@Description (@Section) : @perc',
            x_range = (-2, 2)
            )
    ...
    def make_nation_map(src):
        ...
        p.patches('xs', 'ys', source = world_src,
            fill_color = 'linen',
            line_color = 'gray')

        p.circle(x = 'x', y = 'y', color = 'peru', source = src, size = 10,
            fill_alpha = 0.4, radius = 'radius')
    ...
    def make_gender_plot(src):
        ...
        p1.quad(source = src, bottom = 0, top = 'age',
            left = 'left', right = 'right',
            color = 'deepskyblue', fill_alpha = 0.7,
            hover_fill_color = 'navy',
            legend = 'Average Age of New Founders',
            hover_fill_alpha = 1.0, line_color = 'black')

        hover1 = HoverTool(tooltips = [
            ('Year', '@year'),
            ('Average Age of New Founders', '@age'),
    ...
    nation_description_9 = Div(
        ...
        in the companies' countries of origin. Indeed, the number of counries
        ...
        and 2020. Companies from Asis, Africa and America began to be more
